package com.identitycardcheckerservice.service;

import com.google.gson.Gson;
import com.google.gson.JsonObject;
import com.identitycardcheckerservice.kafka.consumer.PatientDetailsConsumer;
import com.identitycardcheckerservice.kafka.producer.CheckerResponseProducer;
...
import com.identitycardcheckerservice.models.dto.ValidationResponseDTO;
import com.identitycardcheckerservice.models.dto.PatientIdentityCardDetailsDTO;
import com.identitycardcheckerservice.repository.CodeRepository;
import com.identitycardcheckerservice.repository.CountyRepository;
import com.identitycardcheckerservice.repository.SeriesRepository;
...
public class IdentityCardCheckerService {
    ...
    public void validateIdentityCardDetails(String value) {
        ...
        checkerResponseProducer.sendMessage(checkerResponseTopic, dtoAsString);
    }
    ...
    private boolean checkJJComponent(String countyCode, String countyName) {
        ...
        return county.get().getCode()
                .stream().anyMatch(p -> p.getId().equals(code.get().getId()));
    ...
    private boolean validCountyAndSeries(String countyName, String seriesName) {
        ...
        return county.get().getSeriesList()
                .stream().anyMatch(p -> p.getId().equals(serie.get().getId()));
    }
